...
# The permission for setgid files is 2000
echo "Setgid files"
echo "============="
find / -type f -executable -perm -2000 -ls 2>/dev/null | sort -k 3
echo ""

echo "10 Largest regular files sorted by their sizes in MB, file name, owner"
echo "============"

## to find file use -type f and ls -l  will list the files  and --block-size will convert the file into MB. To redirect error /dev/null is used and sort is used to sort the file as a reverse order using -rh option
##head is used to get top 10 files and awk is used to get desired output.
